    ...
    sidebar: {
      ...
      '/java/': [
        ...
        },
        {
          ...
          children: [
            ...
            '/java/02-数据库/03-数据库的基本查询.md',
            '/java/02-数据库/04-数据库的高级查询.md',
          ]
        },
      ],
      '/vue2/': [
      ...
      '/architect/': [
        ...
        },
        {
          ...
          children: [
            ...
            '/architect/02-脚手架涉及和框架搭建/04-脚手架的开发流程',
            '/architect/02-脚手架涉及和框架搭建/05-Lerna简介',
            '/architect/02-脚手架涉及和框架搭建/06-Lerna源码解析',
          ],
          // children: genSidebarConfig('architect/02-脚手架涉及和框架搭建', true)
        },
        {
          title: '03-脚手架核心流程开发',
          collapsable: false,
          children: [
            '/architect/03-脚手架核心流程开发/01-脚手架需求分析',
            '/architect/03-脚手架核心流程开发/02-脚手架架构设计',
            '/architect/03-脚手架核心流程开发/01-脚手架需求分析',
            '/architect/03-脚手架核心流程开发/01-脚手架需求分析',
          ],
        },
      ...
      '/algorithm/': [
        ...
        },
        {
          title: '02-递归无处不在',
          collapsable: false,
          children: ['/algorithm/02-递归无处不在/01-归并排序法的原理'],
        },
        {
          title: 'js版',
          collapsable: false,
